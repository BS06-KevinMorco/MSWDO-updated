    ...
    <div class="container">
        <div class="pwd-home">
            ...
            if (isset($_GET['ref_code'])) {
                ...
                $query = "SELECT * FROM senior_info WHERE ref_code='$ref_code' ";
                        ...
                        <div class="pwd-register" style="margin-top: 50px;">
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane container fade" id="personal-info">
                                    <form method="post" action="update-senior-clientside.php">
                                        ...
                                        <div class="row jumbotron">
                                            <div class="col-sm-6 form-group">
                                                ...
                                                <input type="hidden" name="senior_id" value="<?= $row['senior_id']; ?>">
