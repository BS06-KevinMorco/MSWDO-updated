...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div class="sidebar" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                <li class="">
                    <a href="pwd-admin.php" class="list-group-item bg-transparent second-text border-bottom"><i class="fa-solid fa-house-user me-2"></i>Dashboard</a>
                </li>
                <li class="active">
                    <a href="#" class="list-group-item bg-transparent second-text border-bottom fw-bold active"><i class="fa-solid fa-wheelchair me-2"></i>PWD Requests</a>
                </li>
            </div>
        </div>
        <!-- /#sidebar-wrapper -->
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                <div class="row my-5">
                    <h3 class="fs-4 mb-3">Total Number of PWD Applicant Requests</h3>
                    <div class="col">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-warning" data-bs-toggle="modal" type="button" data-bs-target="#update_modal<?php echo $row['pwd_id'] ?>">
                                                    <i class="fas fa-edit">
                                                    </i></button>
                                            </td>
                                            <div class="modal fade" id="update_modal<?php echo $row['pwd_id'] ?>" aria-hidden="true">
                                                <div class="modal-dialog modal-xl">
                                                    <div class="modal-content modal-xl">
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="POST" action="update-pwd.php" id="form" enctype="multipart/form-data">
                                                                ...
                                                                <div class="row jumbotron">
                                                                    ...
                                                                    <input type="hidden" name="pwd_id" value="<?php echo $row['pwd_id'] ?>" />
                                                                ...
                                                                <div class="col-sm-12 form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="father_name" id="father-name" value="<?php echo $row['father_name'] ?>" onblur="fathernameEmpty();" placeholder="Type here" required>
                                                                    <p id="flash-error-fathername" class="flash-error">This field cannot be empty</p>
                                                                </div>
                                                                <div class="col-sm-12 form-group">
                                                                    <label for="mother-name">Mother's Name</label>
                                                                    <input type="text" class="form-control" name="mother_name" id="mother-name" value="<?php echo $row['mother_name'] ?>" onblur="mothernameEmpty();" placeholder="Type here" required>
                                                                ...
                                                                <div class="col-sm-12 form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="guardian_name" id="guardian-name" value="<?php echo $row['guardian_name'] ?>" onblur="guardiannameEmpty();" placeholder="Type here" required>
                                                                ...
                                                                <div class="col-sm-12 form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="guardian_contact" id="guardian-contact" value="<?php echo $row['guardian_contact'] ?>" onblur="guardiancontactEmpty();" placeholder="+09XXXXXXXXX" required>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-12 form-group">
                                                                        <label for="application-status">PWD Application Status</label>
    ...
    mysqli_query($mysqli, "UPDATE pwd_info SET fname = $fname, mname = '$mname', 'lname' = '$lname' WHERE 'pwd_id' = '$pwd_id'");
                                            ...
                                            ?> <td>
                                                <a href="delete-pwd.php?pwd_id=<?php echo $row['pwd_id']; ?>">
                                                    <button type="submit" class="btn btn-danger" id="" onclick="return confirm('WARNING: Details will be permanently removed.')">
